...
**B样条曲线$C(u)$是一个分段曲线，每个组成部分都是$p$次的曲线。**
...
**clamped B样条曲线$C(u)$通过两个端点控制点$P_0$和$P_n$**
...
**局部修改特性：改变控制点$P_i$的位置只影响区间$[u_i, u_{i+p+1})$上的曲线$C(u)$**
